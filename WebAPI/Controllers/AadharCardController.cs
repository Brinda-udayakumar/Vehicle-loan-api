...
namespace WebAPI.Controllers
{
    ...
    public class AadharCardController : ControllerBase
    {
        ...
        private void SaveToDB(FileRecord record)
        {
            ...
            AadharCard fileData = new AadharCard();
            ...
            dbContext.AadharCard.Add(fileData);
        ...
        public List<FileRecord> GetAllFiles()
        {
            ...
            return dbContext.AadharCard.Select(n => new FileRecord
            {
        ...
        public async Task<IActionResult> DownloadFile(int id)
        {
            ...
            var file = dbContext.AadharCard.Where(n => n.CustomerId == id).FirstOrDefault();
