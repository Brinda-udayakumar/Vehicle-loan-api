...
namespace WebAPI.Controllers
{
    ...
    public class SalarySlipController : ControllerBase
    {
        ...
        private void SaveToDB(FileRecord record)
        {
            ...
            SalarySlip fileData = new SalarySlip();
            ...
            dbContext.SalarySlip.Add(fileData);
        ...
        public List<FileRecord> GetAllFiles()
        {
            ...
            return dbContext.SalarySlip.Select(n => new FileRecord
            {
        ...
        public async Task<IActionResult> DownloadFile(int id)
        {
            ...
            var file = dbContext.SalarySlip.Where(n => n.CustomerId == id).FirstOrDefault();
